...
@testable import AdapterKataSolutionCode
...
struct Stub {
    static let popularityBasedServiceProducts = [
        PopularityBasedServiceProduct(
            ...
            popularityDateIntroduced: DateStub.appleWatchUltra
        ),
        PopularityBasedServiceProduct(
            popularityIdentifier: "4321",
            popularityTitle: "Vision Pro",
            popularityDateIntroduced: DateStub.visionPro
        ),
    ]
...
@Test func testTask1() {
    ...
    #expect(products[0].dateIntroduced == DateStub.appleWatchUltra)
...
@Test func testTask3() {
    ...
    #expect(products[2].dateIntroduced == DateStub.iPhone15Pro)
}
