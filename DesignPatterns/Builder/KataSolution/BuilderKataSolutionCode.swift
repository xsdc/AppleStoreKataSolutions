...
class UltraSeriesBuilder: AppleWatchBuilder {
    private var appleWatch = AppleWatch(
        ...
        size: Size.fortyNine.rawValue,
        material: Material.naturalTitanium.rawValue,
        band: Band.trailLoop.rawValue,
        engraving: Engraving.none.rawValue
    )
